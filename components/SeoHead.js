...
const defaultMeta = {
  ...
  url: "https://unesa-learn.vercel.app",
  type: "website",
  robots: "follow, index",
  // change with url of your image (recommended dimension = 1.91:1)
  // used in twitter, facebook, etc. card when link copied in tweet/status
  image: "https://unesa-learn.vercel.app/assets/card-image.png",
  author: "Lorem Ipsum",
};
...
const SeoHead = (props) => {
  ...
  return (
    <Head>
      ...
      {/* Windows 8 app icon */}
      <meta name="msapplication-TileColor" content="#1B2143" />
      <meta
        name="msapplication-TileImage"
        content="/favicon/ms-icon-144x144.png"
      />
      {/* Accent color on supported browser */}
      <meta name="theme-color" content="#1B2143" />
    </Head>
  );
};
